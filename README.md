...
- Mailgun을 이용한 메일보내기.  
    ...
    : KETI에 설치해둔 것은 6시30분에 이메일 보내도록 수정함. 두 장치에서 같은 계정으로 동시에 보내니깐 하나는 안 옴.(이틀 동안 2개 받아보았는데 한번은 연구실 장치에서 오고 한번은 KETI 장치에서 옴.)  
    : !!개발중 알게된 내용 참고!! web2py 내부에서는 Popen으로 커맨드 결과 받는 동작이 안됨. 구글링 해보니 안된다고 하는데 바빠서 일단 넘겼는데 자세히 알아볼 필요가 있음.  
